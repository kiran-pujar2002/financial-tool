          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">{report.industry || 'Industry not specified'}</p>
          ...
          <div className="bg-red-50 border border-red-200 rounded-2xl p-6 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-red-600 mt-1">Try uploading the file again, or contact support if this persists.</p>
              </div>
            </div>
          </div>
        )}
                ...
                <div>
                  {isCompleted ? (
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-xl font-medium hover:shadow-lg transition-all duration-200"
                    >
                      <Download size={18} />
                      Download PDF
                    </a>
...
function MetricCard({ label, value, highlight, icon }) {
  return (
    <div className={`bg-white rounded-2xl shadow-sm border border-slate-200 p-4 hover:shadow-md transition-all duration-200 ${highlight ? 'border-indigo-300 ring-1 ring-indigo-300' : ''}`}>
